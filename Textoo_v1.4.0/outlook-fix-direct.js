// SOLUTION DIRECTE POUR OUTLOOK - Script à exécuter dans la console
(function() {
  console.log('=== SOLUTION DIRECTE OUTLOOK ===');
  ...
  function patchGetLastMessageText() {
    ...
    const originalGetLastMessageText = window.getLastMessageText;
  ...
  function patchHandleDirectQuickReply() {
    ...
    if (typeof window.handleDirectQuickReply === 'function') {
      console.log('Fonction handleDirectQuickReply() trouvée, remplacement...');
    } else {
      console.log('Fonction handleDirectQuickReply() non trouvée, création...');
    }
