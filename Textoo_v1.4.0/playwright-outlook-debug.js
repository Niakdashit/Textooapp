// Script Playwright pour déboguer Outlook
const { chromium } = require('playwright');

async function debugOutlookMessageRetrieval() {
  console.log('=== DÉBOGAGE PLAYWRIGHT OUTLOOK ===');
  ...
  try {
    ...
    console.log('📸 Capture d\'écran sauvegardée: outlook-page.png');
    
    // Analyser tous les éléments de texte sur la page
    ...
    console.log(`\n3. Éléments de texte trouvés: ${allTextElements.length}`);
    
    if (allTextElements.length > 0) {
      console.log('\n📧 Messages potentiels trouvés:');
